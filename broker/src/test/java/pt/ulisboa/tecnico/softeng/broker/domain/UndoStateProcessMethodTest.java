...
public class UndoStateProcessMethodTest {
	...
	@Test
	public void successRevertPaymentAndActivityAndRoomAndVehicle(@Mocked final BankInterface bankInterface,
			@Mocked final ActivityInterface activityInterface, @Mocked final HotelInterface roomInterface,
	...
	@Test
	public void successRevertActivityAndVehicle(@Mocked final ActivityInterface activityInterface,
			@Mocked final CarInterface carInterface) {
		this.adventure.setPaymentCancellation(PAYMENT_CANCELLATION);
		this.adventure.setActivityConfirmation(ACTIVITY_CONFIRMATION);
		this.adventure.setVehicleConfirmation(VEHICLE_CONFIRMATION);
	...
	@Test
	public void successRevertPaymentAndVehicle(@Mocked final BankInterface bankInterface,
			@Mocked final CarInterface carInterface) {
		this.adventure.setPaymentConfirmation(PAYMENT_CONFIRMATION);
		this.adventure.setActivityCancellation(ACTIVITY_CANCELLATION);
		this.adventure.setVehicleConfirmation(VEHICLE_CONFIRMATION);
	...
	@Test
	public void successRevertPaymentAndActivityAndRoomAndVehicleButCarException(@Mocked final BankInterface bankInterface,
			@Mocked final ActivityInterface activityInterface, @Mocked final HotelInterface roomInterface,
			@Mocked final CarInterface carInterface) {
		this.adventure.setPaymentConfirmation(PAYMENT_CONFIRMATION);
		this.adventure.setActivityConfirmation(ACTIVITY_CONFIRMATION);
	...
	@Test
	public void successRevertPaymentAndActivityAndRoomAndVehicleButRemoteAccessException(
			@Mocked final BankInterface bankInterface, @Mocked final ActivityInterface activityInterface,
