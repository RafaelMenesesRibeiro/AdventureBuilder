...
public class ClientController {
	...
	public String submitClient(Model model, @PathVariable String brokerCode, @ModelAttribute ClientData clientData) {
		logger.info("submitClient borkerCode:{}, drivingLicense:{}, age:{}, nif:{}, iban:{}", brokerCode,
				clientData.getDrivingLicense(), clientData.getAge(), clientData.getNif(), clientData.getIban());
