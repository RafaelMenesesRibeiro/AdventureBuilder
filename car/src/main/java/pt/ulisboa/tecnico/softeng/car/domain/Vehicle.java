...
import pt.ulisboa.tecnico.softeng.car.exception.RentACar;
...
public class Vehicle {
	...
	*/
	...
	private void checkDealer(RentACar dealer) {
		if (dealer == null) {
			throw CarException("A non null dealer must be associated with this car.");
		}
	}
	...
	public void setKilometers(int km) {
		if (km < this.kilometers) {
			throw CarException("Car kilometers may only be raised.");
		} else {
			this.kilometers = km;
		}
	}
	...
	public void isFree(begin, end) {
		// TODO
	}

	public void rent(drivingLicense, begin, end) {
		// TODO
	}
}
