...
public class InvoiceProcessorSubmitHotelBookingMethodTest {
	...
	private static final String guestIban = "guestIban";
	private static final String guestNif = "267085649";
	...
	@Before
	public void setUp() {
		this.hotel = new Hotel("7777777", "RitzCarlton", "365975512", "HotelIBAN", 200, 480);
		this.room = new Room(this.hotel, "18", Room.Type.SINGLE);
		this.hotelBooking = this.room.reserve(Room.Type.SINGLE, arrival, departure, this.guestNif, this.guestIban);
	}
	...
	public void success(@Mocked final TaxInterface taxInterface, @Mocked final BankInterface bankInterface) {
		...
		this.hotel.getProcessor().submitHotelBooking(this.hotelBooking);
	...
	public void oneTaxFailureOnSubmitInvoice(@Mocked final TaxInterface taxInterface, @Mocked final BankInterface bankInterface) {
		...
		this.hotel.getProcessor().submitHotelBooking(this.hotelBooking);
		this.hotel.getProcessor().submitHotelBooking(new Booking(this.hotel, this.room, arrival, departure, this.guestNif, this.guestIban));
